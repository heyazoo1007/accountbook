...
public class ControllerExceptionHandler {
    ...
    protected ApiResponse<Object> handleRequest(final BindException e) {
    ...
    protected ApiResponse<Object> handleHttpMessageNotReadableException(
    ...
    protected ApiResponse<Object> handleTypeMismatchException(final TypeMismatchException e) {
        ...
        return ApiResponse.error(
                ...
                String.format(
                        "%s (%s)",
                        VALIDATION_WRONG_TYPE_EXCEPTION.getMessage(),
                        e.getValue())
        );
    }
    ...
    protected ApiResponse<Object> handleHttpMediaTypeNotAcceptableException(
    ...
    protected ApiResponse<Object> handleHttpMediaTypeException(
    ...
    /**
     * MoneyBook Custom Exception
     */
    @ExceptionHandler(AccountBookException.class)
    protected ResponseEntity<ApiResponse<Object>> handleBaseException(
            AccountBookException e
    ) {
        log.error(e.getMessage(), e);
